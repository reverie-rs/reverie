...
pub const DET_TLS_SYSTRACE_GLOBAL_STATE: u64 =
    DET_TLS_SYSTOOL_LOG_LEVEL + std::mem::size_of::<u64>() as u64;
...
fn det_tls_sanity_check() {
    ...
    assert_eq!(DET_TLS_SYSTRACE_GLOBAL_STATE, DET_PAGE_TLS + 64);
}
