pub const REVERIE_TRACEE_PRELOAD: &'static str = "REVERIE_TRACEE_PRELOAD";

pub const REVERIE_ENV_TOOL_LOG_KEY: &'static str = "TOOL_LOG";
...
pub const REVERIE_GLOBAL_STATE_FILE: &'static str = "reverie";
...
pub const REVERIE_LOCAL_SYSCALL_HOOK_SIZE: u64 = REVERIE_LOCAL_BASE + 0x0;
