...
fn main() -> io::Result<()> {
    ...
    let msg = "// AUTOMATICALLY GENERATED by build.rs by copying reverie/trampoline/ffi.rs. DO NOT EDIT.\n\n";
    prepend_file(msg.as_bytes(), &filepath)?;

    let filepath = PathBuf::from("src/consts.rs");
    let msg = "// AUTOMATICALLY GENERATED by build.rs by copying reverie/src/consts.rs. DO NOT EDIT.\n\n";
    prepend_file(msg.as_bytes(), &filepath)
}
