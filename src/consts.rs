...
pub const DET_TLS_STACK_NESTING_LEVEL: u64 = DET_TLS_STUB_SCRATCH + std::mem::size_of::<u64>() as u64;

pub const DET_TLS_SYSCALL_TRAMPOLINE: u64 = DET_TLS_STACK_NESTING_LEVEL + std::mem::size_of::<u64>() as u64;
